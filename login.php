...
<div class="container mt-5">
    <div class="login-container">
        ...
        <center><a class="register-link" href="user/register.php">Não tem uma conta? <b>Registrar</b></a>
        <a style="font-size: 14px;" href="recuperar_senha.php">Esqueceu sua senha?</a></center>
    </div>
</div>
</body>
</html>
